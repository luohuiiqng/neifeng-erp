...
export const ACTION_DEFS = [
  ...
  { key: 'action_mo_issue', title: '操作·生产订单·厂长下发（草稿→已下发）' },
  { key: 'action_mo_workshop_judge', title: '操作·生产订单·车间主任判读（已下发/备货中/生产中）' },
  { key: 'action_design_complete', title: '操作·生产订单·设计完成（设计中→备货中）' },
  { key: 'action_mo_request_ship', title: '操作·生产订单·申请出货审批（生产中→待出货审批）' },
  { key: 'action_ship_release', title: '操作·出货审批·厂长同意出货（待出货审批→待出货）' },
  { key: 'action_ship_reject', title: '操作·出货审批·厂长退回生产（待出货审批→生产中）' },
  { key: 'action_ship_submit', title: '操作·出货确认提交（车间主任）' },
